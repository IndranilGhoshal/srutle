...
export default function ProductComponent({ id }) {
    ...
    const onshare =  () =>{
        let copy = Clipboard(window.location.href)
        if(copy){
            onMessage("Copy Successful", true)
        }
    }
                                    ...
                                    <div className="lg-thum-thumbs myfavr">
                                        <div className="swiper-wrapper">
                                            <div className="swiper-slide">
                                                ...
                                                <button className="btn ntn-view" onClick={()=>{onshare()}}><i className="bi bi-share-fill"></i></button>
                                                <InnerImageZoom
                                                    src={"/upload/" + images}
                                                    alt="pi"
                                                    width={500}
