...
import AllProductListSkeleton from './_skeleton/AllProductListSkeleton'
                                                        ...
                                                        {list.map((item, i) => (
                                                            <div key={i} className="fade-in category-item">
                                                                ...
                                                                <div className="fade-in prod-dtls">
                                                                    <p className='lst-txt-wp-tw' onClick={() => { goto('/product/' + item._id) }}>{item.name}</p>
                                                                    {
                                                                        item.name.length < 22 ? <div style={{height: '15px'}}>&nbsp;</div>:<></>
                                                                    }
