...
export default function LoginModal({ onMessage, setUser }) {
    ...
    return (
        <>
            <a id="loginbutton" className="signin cp" onClick={handleShow}>Sign in</a>
            <Modal
                show={show}
                backdrop="static"
                keyboard={false}
                        ...
                        </div>
                        {
                            !otpdiv ?
                                ...
                                <div className="login-mod-right">
                                    ...
                                    <p className="trm-cond">By signing in, I agree to <a className='text-blue' onClick={()=>{goto('/termsconditions')}}>Terms & Conditions</a>, and
                                        <a className='text-blue' onClick={()=>{goto('/privacypolicy')}}> Privacy Policy</a></p>
                                </div>
                        }
                    </div>
                </Modal.Body>
