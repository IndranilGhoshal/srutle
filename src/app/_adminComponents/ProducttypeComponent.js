...
import { getEditPermission, getLocalStorageData, hideLoader, showLoader } from '../lib/common'
...
export default function ProducttypeComponent() {
    ...
    useEffect(() => {
        if (!getLocalStorageData("admin")) {
            ...
            router.push("/admin/account/producttype");
        ...
        <>
            <div className="main-das-page">
                <div className="heading my-3">
                    ...
                    <ProductTypeModal isedit={isedit} onMessage={onMessage} />
                </div>
                <div className='mt-2'>
