...
import SellerListSkeleton from '../_skeleton/SellerListSkeleton';
            ...
            <div className="mastr_hw">
                <div className="assects_src_dv position-relative">
                    ...
                    <input
                        ...
                        placeholder='Search by Seller Name or Email Id'
                            ...
                            <tbody>
                                {
                                    list !== undefined ?
                                                ...
                                                list.length > 0 ? list.map((item, i) => (
                                                    <tr role="row" key={i}>
                                                        ...
                                                        <td align="left" className='lst-td'>
                                                            ...
                                                            <div className='txt-wp'>{item.name}</div>
                                                            </div>
                                                        </td>
                                                            ...
                                                            <div className="dropdown-menu dropdown-menu-end">
                                                                <div className="filter-lists">
                                                                    <div className='edtbtn'>
                                                                        <button disabled={isedit} onClick={()=>{goto('/sellerdetails/'+item._id)}}><i className="bi bi-person-workspace me-2"></i> View Seller</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                        ...
                                        :
                                        <>
                                            {list == undefined && <SellerListSkeleton />}
                                        </>
                                }
                            </tbody>
                        </table>
                    ...
                    <div className="paginati">
                        <div className="paginati_l">
                            ...
                            <div className="dataTables_length d-flex align-items-center" id="datatables-reponsive_length">
                                ...
                                <span>{list && list.length} Seller{list && list.length > 1 ? "s" : ""} <strong>per page</strong></span>
