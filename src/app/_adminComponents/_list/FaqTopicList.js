...
export default function FaqTopicList({
    ...
    const editEvent = async () => {
        ...
        if (err == 0) {
            let data = { id, image, title, description, status: statusVal, editfaqtopic: true }
    ...
    return (
        <>
                            ...
                            <tbody>
                                {
                                    list !== undefined ?
                                                                ...
                                                                <div className="filter-lists">
                                                                    <div className='edtbtn'>
                                                                        <button onClick={() => { handleEditShow(item) }} disabled={isedit}>
                                                                            <i className="bi bi-pencil-square me-2"></i> Edit Faq
                                                                        </button>
                                                                    </div>
                                                                    <div className='edtbtn'>
                                                                        <button onClick={() => { goto("/faqdetails/" + item._id), showLoader() }} disabled={isedit}><i className="bi bi-universal-access me-2"></i>FAQ Config</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                        ...
                                        :
                                        <>
                                            {list == undefined && <FaqTopicListSkeleton />}
                                        </>
                                }
                            </tbody>
                        </table>
                ...
                <Modal.Body style={{ padding: 0 }}>
                    <div className="modal-content">
                        <div className="modal-header border-0">
                            <h4 className='text-blue'>Edit FAQ Topic</h4>
                            <button
            ...
            >
                ...
                <Modal.Body>Are you sure delete this faq?</Modal.Body>
                <Modal.Footer>
