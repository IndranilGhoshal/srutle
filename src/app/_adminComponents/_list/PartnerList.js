...
import PartnerListSkeleton from '../_skeleton/PartnerListSkeleton';
            ...
            <div className="mastr_hw">
                <div className="assects_src_dv position-relative">
                    ...
                    <input
                        ...
                        placeholder='Search by Partner Name or Email Id'
                            ...
                            <tbody>
                                {
                                    list !== undefined ?
                                                ...
                                                list.length > 0 ? list.map((item, i) => (
                                                    <tr role="row" key={i}>
                                                        ...
                                                        <td align="left" className='lst-td'>
                                                            ...
                                                            <div className='txt-wp-sm'>{item.name}</div>
                                                            </div>
                                                        </td>
                                                        <td align="left"><div className='txt-wp-sm'>{item.email}</div></td>
                                                            ...
                                                            <div className="dropdown-menu dropdown-menu-end">
                                                                <div className="filter-lists">
                                                                    <div className='edtbtn'>
                                                                        <button disabled={isedit} onClick={() => { goto("/partnerdetails/" + item._id) }}><i className="bi bi-person-workspace me-2"></i> View Partner</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                        ...
                                        :
                                        <>
                                            {list == undefined && <PartnerListSkeleton />}
                                        </>
                                }
                            </tbody>
                        </table>
                    ...
                    <div className="paginati">
                        <div className="paginati_l">
                            ...
                            <div className="dataTables_length d-flex align-items-center" id="datatables-reponsive_length">
                                ...
                                <span>{list && list.length} partner{list && list.length > 1 ? "s" : ""} <strong>per page</strong></span>
