                                                ...
                                                list.length > 0 ? list.map((item, i) => (
                                                    <tr role="row" key={i}>
                                                        ...
                                                        <td align="left" className='lst-td'>
                                                            ...
                                                            <div className='txt-wp-sm'>{item.title}</div>
                                                            
                                                            </div>
                                                        </td>
                                                        <td align="left">{item.noofuse}</td>
                                                            ...
                                                            <div className="dropdown-menu dropdown-menu-end">
                                                                <div className="filter-lists">
                                                                    <div className='edtbtn'>
                                                                        <button disabled={isedit} onClick={() => { goto("/giftcardconfiguration/" + item._id), showLoader() }}><i className="bi bi-gear me-2"></i>Set Configuration</button>
                                                                    </div>
                                                                    <div className='edtbtn'>
                                                                        <button
                                                                        disabled={isedit}
                                                                        ...
                                                                        >
                                                                            <i className="bi bi-pencil-square me-2"></i> Edit Gift Card
                                                                        </button>
                ...
                <Modal.Body style={{ padding: 0 }}>
                    <div className="modal-content">
                        <div className="modal-header border-0">
                            <h4 className='text-blue'>Edit Gift Card</h4>
                            <button
                                id="giftcardclsBtn"
                                type="button"
