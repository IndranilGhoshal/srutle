...
export default function ProductList({ list, limit, setlimit, handleChangePage, page, search, setSearch, onStatus,isedit }) {
    return (
        <>
                                                ...
                                                list.length > 0 ? list.map((item, i) => (
                                                    <tr role="row" key={i}>
                                                        ...
                                                        <td align="left" className='lst-td'>
                                                            ...
                                                            <div className='txt-wp'>{item.productname}</div>
                                                            </div>
                                                        </td>
                                                                ...
                                                                <div className="filter-lists">
                                                                    <div className='edtbtn'>
                                                                        <button disabled={isedit}>
                                                                            <i className="bi bi-box-seam me-2"></i> View Product
                                                                        </button>
