...
import ConsumerListSkeleton from '../_skeleton/ConsumerListSkeleton';
            ...
            <div className="mastr_hw">
                <div className="assects_src_dv position-relative">
                    ...
                    <input
                        ...
                        placeholder='Search by Consumer Name or Email Id or Contact No.'
                            ...
                            <tbody>
                                {
                                    list !== undefined ?
                                        <>
                                            {
                                                list.length > 0 ? list.map((item, i) => (
                                                    <tr role="row" key={i}>
                                                        ...
                                                        <td align="left"><div className='txt-wp-sm'>{!item.email ? "-" : item.email}</div></td>
                                                        <td align="left"><div className='txt-wp-sm'>{item.phone}</div></td>
                                                            ...
                                                            <div className="dropdown-menu dropdown-menu-end">
                                                                <div className="filter-lists">
                                                                    <div className='edtbtn'>
                                                                        <button disabled={isedit} onClick={() => { goto("/consumerdetails/" + item._id) }}><i className="bi bi-person-workspace me-2"></i> View Consemer</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                        ...
                                        :
                                        <>
                                            {list == undefined && <ConsumerListSkeleton />}
                                        </>
                                }
                            </tbody>
                        </table>
                    ...
                    <div className="paginati">
                        <div className="paginati_l">
                            ...
                            <div className="dataTables_length d-flex align-items-center" id="datatables-reponsive_length">
                                ...
                                <span>{list && list.length} Consumer{list && list.length > 1 ? "s" : ""} <strong>per page</strong></span>
