                                        ...
                                        <>
                                            {
                                                list.length > 0 ? list.map((item, i) => (
                                                    <tr role="row" key={i}>
                                                        ...
                                                        <td align="left"><div className='txt-wp'>{moment(item.createdAt).format('MMMM Do YYYY, h:mm:ss a')}</div></td>
                                                        <td align="left">
                                                            ...
                                                            <div className="dropdown-menu dropdown-menu-end">
                                                                <div className="filter-lists">
                                                                    <div className='edtbtn'>
                                                                        <button onClick={() => { goto('/productconfigaration/' + item._id) }}><i className="bi bi-gear me-2"></i> Set Configuration</button>
                                                                    </div>
                                                                    <div className='edtbtn'>
                                                                        <button
                                                                        onClick={() => { onEdit(item._id) }}
                                                                        >
                                                                            <i className="bi bi-pencil-square me-2"></i> Edit Product Type
                                                                        </button>
                ...
                <Modal.Body style={{ padding: 0 }}>
                    <div className="modal-content">
                        <div className="modal-header border-0">
                            <h4 className='text-blue'>Edit Product Type</h4>
                            <button
                                type="button"
