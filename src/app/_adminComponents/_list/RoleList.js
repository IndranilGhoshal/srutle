...
import { getEditPermission, getLocalStorageData, showLoader } from '@/app/lib/common';
import RoleListSkeleton from '../_skeleton/RoleListSkeleton';
                            ...
                            <tbody>
                                {
                                    role !== undefined ?
                                                            ...
                                                            <div className="dropdown-menu dropdown-menu-end">
                                                                <div className="filter-lists">
                                                                    <div className='edtbtn'>
                                                                        <button onClick={() => { goto("/privilege/" + item._id), showLoader() }} disabled={isedit}><i className="bi bi-universal-access me-2"></i>Set Privileges</button>
                                                                    </div>
                                                                    <div className='edtbtn'>
                                                                        <button onClick={() => { handleEditShow(item) }} disabled={isedit}>
                                                                            <i className="bi bi-pencil-square me-2"></i> Edit Role
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        :
                                        <>
                                            {role == undefined && <RoleListSkeleton />}
                                        </>
                                }
                            </tbody>
                        </table>
                    ...
                    <div className="paginati">
                        <div className="paginati_l">
                            ...
                            <div className="dataTables_length d-flex align-items-center" id="datatables-reponsive_length">
                                ...
                                <span>{role && role.length} role{role && role.length > 1 ? "s" : ""} <strong>per page</strong></span>
                ...
                <Modal.Body style={{ padding: 0 }}>
                    <div className="modal-content">
                        <div className="modal-header border-0">
                            <h4 className='text-blue'>Edit Role</h4>
                            <button
                                id="clsBtn1"
                                type="button"
