...
export default function AdminAccountHeader() {
                    ...
                    <ul className="navbar-nav navbar-align nav-bar-ul">
                        <li className="nav-item dropdown">
                            ...
                            <div className="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
                                ...
                                <div className="dropdown-menu-footer ntf-ftt">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            >
                                <a className="dropdown-item my-1" onClick={() => { goto('/settings?tab=admin-details-tab') }} ><i className="bi bi-gear"></i> Settings</a>
                                <a className="dropdown-item my-1" onClick={() => { goto('/activitylog') }}><i className="bi bi-activity"></i> Activity Logs</a>
                                <LogoutModal />
                            </div>
                        </li>
                    </ul>
