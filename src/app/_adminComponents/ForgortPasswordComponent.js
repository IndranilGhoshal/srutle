                    ...
                    <>
                        <div className='send-email'>
                            <div className='send-email-sceess my-4'>
                                <Image className='log-logo-img m-auto' src={"/assets/seller-img/srutle-logo.png"} width={250} height={100} alt='login' />
                            </div>
                            <div className='send-email-sceess-md'>
                                <Image
                                    src={"/assets/img/emailsend.jpg"}
                                    width={800}
                                    height={500}
                                    alt='email send'
                                />
                            </div>
                            <div className='send-email-sceess-bdy'>
                                <div className='send-email-sceess-txt'>
                                    <h3>{ismessage}</h3>
                                </div>
                            </div>
                            <div className='send-email-sceess-btn'>
