...
import { getEditPermission, hideLoader, showLoader } from '../lib/common'
            ...
            <div>
                ...
                >
                    <Tab eventKey="Seller" title="Seller">
                        ...
                        {
                            editorLoaded &&
                            <button disabled={isedit} onClick={() => { addsellerdata() }} className='btn down_btn my-3'>Save</button>
                        }
                    </Tab>
                    <Tab eventKey="Consumer" title="Consumer">
                        ...
                        {
                            editorLoaded &&
                            <button disabled={isedit} onClick={() => { addconsumerdata() }} className='btn down_btn my-3'>Save</button>
                        }
                    </Tab>
                </Tabs>
            </div>
