...
export default function LoginComponent() {
    ...
    useEffect(() => {
        if (getLocalStorageData('seller')?._id) {
            ...
            setLoading(true)
            if (getLocalStorageData('isSellerRemembered')) {
                setEmail(getLocalStorageData('sellerEmail'))
                setPassword(getLocalStorageData('sellerPassword'))
                setIsRemembered(getLocalStorageData('isSellerRemembered'))
            }
            hideLoader()
        }
    }, [])
    ...
    const setremember = () => {
        ...
        if (!isRemembered) {
            ...
            setLocalStorageData('isSellerRemembered', true)
            setLocalStorageData('sellerEmail', email)
            setLocalStorageData('sellerPassword', password)
        } else {
            setIsRemembered(false)
            removeLocalStorageData('isSellerRemembered')
            removeLocalStorageData('sellerEmail')
            removeLocalStorageData('sellerPassword')
        }
    }
