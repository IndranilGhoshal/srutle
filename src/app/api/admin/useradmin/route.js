...
import { authEmail } from "@/app/lib/config";
                ...
                if (adminRes === null) {
                    ...
                    if (result) {
                        ...
                        if (RoleResult) {
                            ...
                            let inviteMail = await InviteAdminEmailFunction({ from: authEmail, to: payload.email, password: systempassword, name: payload.firstName + " " + payload.lastName, role: roleres.role })
                            if (inviteMail) {
                                responsestatus = StatusCodes.SUCCESS
                                success = true;
