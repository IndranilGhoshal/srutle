...
export async function POST(request) {
    ...
    if (middeleware) {
        ...
        // Edit Priviliage
            ...
            let res1 = await adminRoleMenuSchema.findOne({ mstRolesId: payload.role, mstMenusId: payload.menu })
            if (res1) {
                tempObj = {
                ...
                let r = await adminRoleMenuSchema.findOneAndUpdate({ _id: res1._id }, tempObj)
                if (r) {
                    success = true;
                } else {
                    success = false;
