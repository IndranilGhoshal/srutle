...
const faqsTopicModel = new mongoose.Schema({
    image:String,
    title:String,
    description:String,
    status:String,
...
export const faqtopicsSchema = mongoose.models.mstfaqtopics|| mongoose.model("mstfaqtopics", faqsTopicModel);
...
export const tutorialsSchema = mongoose.models.msttutorials|| mongoose.model("msttutorials", tutorialsModel);
